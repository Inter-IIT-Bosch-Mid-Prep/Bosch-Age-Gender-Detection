...
def show_results(img, xywh, conf, landmarks, class_num, j, img_path, sr_model):
...
def detect_one(model, image_path, device, depth, scale, model_gan_path, output_folder, frame_num):
    # Load model
    img_size = 800
    conf_thres = 0.3
    iou_thres = 0.5
